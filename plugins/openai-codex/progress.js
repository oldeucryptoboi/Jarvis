/**
 * Throttled journal event emitter for agent progress events.
...
/**
 * Emit an agent journal event, throttling progress events.
 *
 * @param {import("@karnevil9/journal").Journal} journal
 * @param {string} sessionId
 * @param {string} eventType - One of agent.started, agent.progress, agent.tool_call, agent.completed, agent.failed, agent.aborted
 * @param {Record<string, unknown>} payload
 */
export async function emitAgentEvent(journal, sessionId, eventType, payload) {
