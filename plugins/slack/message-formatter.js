        ...
        elements: [
          {
            ...
            style: "primary",
            action_id: `karnevil9_approval_${requestId}_allow_once`,
          },
          {
            type: "button",
            text: { type: "plain_text", text: "Allow Session" },
            action_id: `karnevil9_approval_${requestId}_allow_session`,
          },
          {
            type: "button",
            text: { type: "plain_text", text: "Deny" },
            style: "danger",
            action_id: `karnevil9_approval_${requestId}_deny`,
          },
        ],
      },
    ],
